...
import { BookOpen, PenLine, Code2, FileText } from 'lucide-react';
...
前往 [项目仓库](https://github.com) 查看源码。

![示例图片](https://picsum.photos/seed/mdpreview/480/240)
...
> 演示模式下代码是预设示例。接入真实模型后，可以按你的具体需求生成代码。`,
...
export const DEMO_PROMPTS = [
  { icon: BookOpen, title: '使用教程', prompt: '这个项目怎么使用？给我一份使用教程' },
  { icon: PenLine, title: '提示词技巧', prompt: '分享一些好用的提示词技巧' },
  { icon: Code2, title: '代码示例', prompt: '写一个 React 计数器组件' },
  { icon: FileText, title: 'Markdown 演示', prompt: '用表格和代码块演示一下 Markdown 渲染' },
];
